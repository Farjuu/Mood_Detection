...
// Draws a bounding box around the face.
        ...
        TextView textView = ((Activity)mContext).findViewById(R.id.faceUpdates);
...
//do nothing
                Toast.makeText(mContext,"if statement",Toast.LENGTH_SHORT).show();
        ...
        final ScrollView mScrollView=((Activity)mContext).findViewById(R.id.scrollView);

        mScrollView.postDelayed(() -> mScrollView.fullScroll(ScrollView.FOCUS_DOWN), 600);
